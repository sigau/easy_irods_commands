...
#     attribut = customtkinter.CTkEntry(win_name_addmeta, width=20)
#     attribut.grid(row=0, column=1)
#     value = customtkinter.CTkEntry(win_name_addmeta, width=20)
#     value.grid(row=1, column=1)
#     units = customtkinter.CTkEntry(win_name_addmeta, width=20)
#     units.grid(row=2, column=1)
#     validate_button = customtkinter.CTkButton(win_name_addmeta,text="validate",command=lambda:[ADD_META_CMD(),CLEAR_TEXT()])
