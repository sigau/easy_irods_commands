...
## Function Dependency View
As part of enhancing the project, I integrated a script visualization tool generated by [Pyan](https://github.com/davidfraser/pyan). When modifying a function, this view displays all the related functions, providing a clear map of the dependencies and connections between the function you're working on and others within the codebase.

You can access the generated views here:: 
- [view/view_api_easicmd.html](./view/view_api_easicmd.html)
- [view/view_api_gui_easicmd.html](./view/view_api_gui_easicmd.html)
